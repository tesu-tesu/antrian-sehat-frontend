            ...
            <Container>
              <Card className="mx-lg-4" style={{
                ...
                <Card.Body className="justify-content-between text-capitalize bg-white">
                    <Row>
                      <Col lg="3">
                        <Card body style={{ fontSize: "29pt"}} className="shadow text-center">
                      ...
                      <Col lg="5" className="pl-6 py-1">
                        ...
                        <Card body>
                          <Row className="mt-4 pr-2 align-items-center"> 
                            ...
                            <Col md="4" style={{fontSize:"27pt"}} className="text-primary">
                              01
                            </Col>
                          </Row>
                        </Card>
                      ...
                      <Col lg="3" className="ml-2 d-flex align-items-center">
                        <div>
                          <span>
                            <Image style={{marginRight: "-25%"}}  className="float-right" width="300px" src={HumanSit}/>
                          </span>
          ...
          <div className="mt-3 mb-3">
            <Container>
              <Card className="mx-lg-4" style={{ borderRadius: "15px"}}>
                <Card.Body>
                    <div className="d-flex justify-content-end mr-4 pr-4" style={{fontSize: "50px"}}>
                      Cari Jadwal?
                    </div>
                    <Row>
                      <Col md="8">
                        <Image  width="100%" className="ml--7 mt--2 float-left" src={Instancies}/>
                      </Col>
                      <Col md="4" className="d-flex align-items-end">
                        <Row>
                          <div style={{fontSize:"30px"}} className="float-right mb-3">
          ...
          <div className="mt-3 mb-4">
              <Card className="mx-lg-4" style={{ borderRadius: "15px"}}>
                    <Card.Body>
                      ...
                      <Row>
                        <Col md="8">
                          <Image width="100%" className="ml--7 float-left" src={Patient}/>
                        </Col>
                        <Col md="4" className="d-flex align-items-end">
                          <Row>
                            <div style={{fontSize:"30px"}} className="float-right mb-3">
